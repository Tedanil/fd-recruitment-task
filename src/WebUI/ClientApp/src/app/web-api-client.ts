...
export interface ITagsClient {
    getTopTags(): Observable<TopTagsVm>;
    getAllTags(): Observable<AllTagsVm>;
}
...
export class TagsClient implements ITagsClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<TopTagsVm>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TopTagsVm>;
        }));
    }

    protected processGetTopTags(response: HttpResponseBase): Observable<TopTagsVm> {
        ...
        if (status === 200) {
            ...
            result200 = TopTagsVm.fromJS(resultData200);
    ...
    getAllTags(): Observable<AllTagsVm> {
        let url_ = this.baseUrl + "/api/Tags/AllTags";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<AllTagsVm>;
                }
            } else
                return _observableThrow(response_) as any as Observable<AllTagsVm>;
        }));
    }

    protected processGetAllTags(response: HttpResponseBase): Observable<AllTagsVm> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AllTagsVm.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export interface ITodoItemsClient {
    ...
    getTodoItemsByTagInList(tagId: number, listId: number): Observable<TodosByTagInListVm>;
...
export class TodoItemsClient implements ITodoItemsClient {
    ...
    getTodoItemsByTagInList(tagId: number, listId: number): Observable<TodosByTagInListVm> {
        let url_ = this.baseUrl + "/api/TodoItems/ByTag/{tagId}/InList/{listId}";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTodoItemsByTagInList(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTodoItemsByTagInList(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<TodosByTagInListVm>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TodosByTagInListVm>;
        }));
    }

    protected processGetTodoItemsByTagInList(response: HttpResponseBase): Observable<TodosByTagInListVm> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TodosByTagInListVm.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export interface ITodoItemTagClient {
    getTagsForTodoItem(todoItemId: number): Observable<TagDto[]>;
    addTagToTodoItem(todoItemId: number, command: CreateTagCommand): Observable<number>;
    removeTagFromTodoItem(todoItemId: number, tagId: number): Observable<FileResponse>;
}

@Injectable({
    providedIn: 'root'
})
export class TodoItemTagClient implements ITodoItemTagClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getTagsForTodoItem(todoItemId: number): Observable<TagDto[]> {
        let url_ = this.baseUrl + "/api/TodoItemTag/{todoItemId}";
        if (todoItemId === undefined || todoItemId === null)
            throw new Error("The parameter 'todoItemId' must be defined.");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTagsForTodoItem(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTagsForTodoItem(response_ as any);
                } catch (e) {
    ...
    protected processGetTagsForTodoItem(response: HttpResponseBase): Observable<TagDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    addTagToTodoItem(todoItemId: number, command: CreateTagCommand): Observable<number> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddTagToTodoItem(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddTagToTodoItem(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<number>;
                }
            } else
    ...
    protected processAddTagToTodoItem(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    removeTagFromTodoItem(todoItemId: number, tagId: number): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/TodoItemTag/{todoItemId}/{tagId}";
        if (todoItemId === undefined || todoItemId === null)
            throw new Error("The parameter 'todoItemId' must be defined.");
        url_ = url_.replace("{todoItemId}", encodeURIComponent("" + todoItemId));
        if (tagId === undefined || tagId === null)
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRemoveTagFromTodoItem(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRemoveTagFromTodoItem(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FileResponse>;
                }
            } else
    ...
    protected processRemoveTagFromTodoItem(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class TopTagsVm implements ITopTagsVm {
    tags?: TagDto[];

    constructor(data?: ITopTagsVm) {
        if (data) {
    ...
    static fromJS(data: any): TopTagsVm {
        data = typeof data === 'object' ? data : {};
        let result = new TopTagsVm();
        result.init(data);
        return result;
    }
...
export class AllTagsVm implements IAllTagsVm {
    tags?: TagDto[];

    constructor(data?: IAllTagsVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AllTagsVm {
        data = typeof data === 'object' ? data : {};
        let result = new AllTagsVm();
        result.init(data);
        return result;
    }
...
export class TodosByTagInListVm implements ITodosByTagInListVm {
    items?: TodoItemDto[];

    constructor(data?: ITodosByTagInListVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TodosByTagInListVm {
        data = typeof data === 'object' ? data : {};
        let result = new TodosByTagInListVm();
        result.init(data);
        return result;
    }
...
export interface ITodosByTagInListVm {
    items?: TodoItemDto[];
}
